 ...
 - :muscle: Создаю проекты с адаптивным макетом, применяя полученные знания. 
 - 
 - :eyes: Все проекты проходят ревью.
 -  Уже не терпится поработать в команде над реальным, "живым" проектом
 - :hammer: А пока повторяю, перечитываю, решаю задачки
